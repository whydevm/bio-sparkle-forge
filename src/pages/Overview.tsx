        ...
        <div className="space-y-3">
          ...
          <div className="bg-card border border-border rounded-lg p-4 flex items-center justify-between">
            <div>
              ...
              <div className="font-medium font-mono">{profile.user_id?.slice(0, 8)}</div>
            </div>
            <div className="p-2">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div className="space-y-2">
                {countryViews.map((cv, idx) => (
                  <div key={idx} className="flex items-center justify-between text-sm">
                    ...
                    <span className="text-muted-foreground">{cv.count} views</span>
                  </div>
                ))}
              </div>
            ) : (
                ...
                {topLinks.map((link, idx) => (
                  <div key={idx} className="flex items-center justify-between text-sm">
                    <div className="flex items-center gap-2">
                      <span className="capitalize text-xs text-muted-foreground">{link.platform}</span>
